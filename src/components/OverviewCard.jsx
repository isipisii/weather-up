...
const OverviewCard = ({ currentWeatherData }) => {
  ...
  return (
    <div className="py-4 px-6 flex items-center gap-4 bg-[#eef2f38f] w-">
      ...
      <div>
        ...
        <div>
          ...
          <h1 className="text-[1.5rem] font-medium text-[#0f2443bc]">{currentWeatherData?.wind?.gust} <span className="text-[#75787aae] text-[1rem] font-normal">Gustiness</span></h1>
        </div>
      </div>
    </div>
  );
